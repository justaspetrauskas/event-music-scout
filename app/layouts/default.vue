<template>
	<div class="pointer-events-auto">
		<SpeedInsights />
		<header class="flex justify-end items-center w-full gap-4 p-4 fixed top-0 z-1">
			<SpotifyLogin />
			<ThemeToggle />
		</header>
		<main class="min-h-screen bg-gradient-to-br bg-white dark:bg-gray-900">
			<div class="mx-auto z-1">
				<slot />
			</div>
